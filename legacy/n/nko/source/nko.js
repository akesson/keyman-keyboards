KeymanWeb.KR(new Keyboard_nko());

function Keyboard_nko() {
    this.KI = "Keyboard_nko";
    this.KBVER = '1.1';
    this.KN = "N'Ko";
    this.KV = {
        F: ' 1em "Ebrima"',
        K102: 0,
        BK: new Array("ߑ", "߁", "߂", "߃", "߄", "߅", "߆", "߇", "߈", "߉", "߀", "߫", "=", "", "", "", "", "ߥ", "ߍ", "ߙ", "ߕ", "ߦ", "ߎ", "ߌ", "ߐ", "ߔ", "[", "]", "\\", "", "", "", "ߊ", "ߛ", "ߘ", "ߝ", "ߜ", "ߤ", "ߖ", "ߞ", "ߟ", ";", "ߴ", "", "", "", "", "", "", "", "", "ߗ", "", "ߓ", "ߣ", "ߡ", "߸", "߲", "߶", "", "", "", "", "", "", "߬", "߹", "@", "߰", "$", "߳", "߮", "&", "*", "(", ")", "_", "+", "", "", "", "", "", "ߋ", "ߚ", "", "", "", "", "ߏ", "", "{", "}", "|", "", "", "", "", "", "", "", "", "", "", "", "", ":", "ߵ", "", "", "", "", "", "", "", "", "", "", "", "ߒ", "", "߱", "߯", "", "", "", "", "", "", "")
    };
    this.KH = '';
    this.KM = 0;
    this.KRTL = 1;
    this.s10 = "qzxvQWTYUIPASDFGHJKLZXCVBM";
    ...
    this.g0 = function(t, e) {
        ...
        if (k.KKM(e, 16400, 49)) {
            ...
            r = m = 1;
            k.KO(0, t, "߫");
        } else if (k.KKM(e, 16384, 190) && k.KCM(2, t, "߲߲", 2)) {
            r = m = 1;
            k.KO(2, t, "߷");
        } else if (k.KKM(e, 16384, 190) && k.KCM(1, t, "߮", 1)) {
            r = m = 1;
            k.KO(1, t, "߭");
        } else if (k.KKM(e, 16384, 190)) {
            r = m = 1;
            k.KO(0, t, "߲");
        } else if (k.KKM(e, 16384, 191) && k.KCM(1, t, "ߖ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߨ");
        } else if (k.KKM(e, 16384, 191) && k.KCM(1, t, "ߗ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߩ");
        } else if (k.KKM(e, 16384, 191) && k.KCM(1, t, "ߙ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߪ");
            ...
            r = m = 1;
            k.KO(0, t, "ߡ");
        } else if (k.KKM(e, 16384, 78) && k.KCM(1, t, "ߣ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߠ");
            ...
            r = m = 1;
        } else if (k.KKM(e, 16384, 87) && k.KCM(1, t, "ߢ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߧ");
            ...
            r = m = 1;
        } else if (k.KKM(e, 16384, 89) && k.KCM(1, t, "ߣ", 1)) {
            r = m = 1;
            k.KO(1, t, "ߢ");
