KeymanWeb.KR(new Keyboard_portuguese_abnt2());

function Keyboard_portuguese_abnt2() {
    this.KI = "Keyboard_portuguese_abnt2";
    this.KN = "Portuguese (Brazilian ABNT2)";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 1,
        BK: new Array("/", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "´", "[", "]", "", "", "", "a", "s", "d", "f", "g", "h", "j", "k", "l", "ç", "~", "", "", "", "", "", "\\", "z", "x", "c", "v", "b", "n", "m", ",", ".", ";", "", "", "", "", "", " ", "?", "!", "@", "#", "$", "%", "¨", "&", "*", "(", ")", "_", "+", "", "", "", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "`", "{", "}", "", "", "", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Ç", "^", "", "", "", "", "", "|", "Z", "X", "C", "V", "B", "N", "M", "<", ">", ":", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "°", "¹", "²", "³", "£", "¢", "¬", "", "", "", "", "", "§", "", "", "", "/", "?", "°", "", "", "", "", "", "", "", "", "ª", "º", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "₢", "", "", "", "", "", "", "", "", "", "", "", "", "")
    };
    this.KH = '';
    this.KM = 0;
    this.s7 = " aAeEiIoOuUy";
    ...
    this.g0 = function(t, e) {
        ...
        if (k.KKM(e, 16384, 32)) {
            ...
            m = 1;
            k.KO(0, t, "Z");
        } else if (k.KKM(e, 16384, 108)) {
            m = 1;
            k.KO(0, t, ".");
        } else if (k.KKM(e, 16400, 108)) {
            m = 1;
            k.KO(0, t, ".");
            ...
            m = 1;
            k.KO(0, t, "\"");
        } else if (k.KKM(e, 16384, 193)) {
            m = 1;
            k.KO(0, t, "/");
        } else if (k.KKM(e, 16400, 193)) {
            m = 1;
            k.KO(0, t, "?");
        } else if (k.KKM(e, 16480, 193)) {
            m = 1;
            k.KO(0, t, "°");
