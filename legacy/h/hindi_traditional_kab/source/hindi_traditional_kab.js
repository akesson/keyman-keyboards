KeymanWeb.KR(new Keyboard_hindi_traditional_kab());

function Keyboard_hindi_traditional_kab() {
    this.KI = "Keyboard_hindi_traditional_kab";
    this.KN = "KAB-Hindi Traditional-Unicode-Inscript";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
