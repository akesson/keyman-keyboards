KeymanWeb.KR(new Keyboard_faroese());

function Keyboard_faroese() {
    this.KI = "Keyboard_faroese";
    this.KN = "faroese";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("½", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "+", "´", "", "", "", "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", "å", "ð", "'", "", "", "", "a", "s", "d", "f", "g", "h", "j", "k", "l", "æ", "ø", "", "", "", "", "", "", "z", "x", "c", "v", "b", "n", "m", ",", ".", "-", "", "", "", "", "", "", "§", "!", "\"", "#", "¤", "%", "&", "/", "(", ")", "=", "?", "`", "", "", "", "Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P", "Å", "Ð", "*", "", "", "", "A", "S", "D", "F", "G", "H", "J", "K", "L", "Æ", "Ø", "", "", "", "", "", "", "Z", "X", "C", "V", "B", "N", "M", ";", ":", "_", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "@", "£", "$", "€", "", "{", "[", "]", "}", " ", "|", "", "", "", "", "", "€", "®", "", "", "", "", "", "", "¨", "~", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "^", "", "", "", "", "", "", "", "", "", "", "", "", "µ", "", "", "", "", "", "", "", "", "")
    };
    this.KH = "<a href='http://help.keymanweb.com/go?Keyboard=faroese'>Help for this keyboard</a>";
    this.s4 = "faroese.kvk";
    ...
    this.s8 = "aAeEiIoOuU";
    this.s9 = "âÂêÊîÎôÔûÛ";
    this.s10 = "aAeEiIoOuUyYcClLnNrRsSzZ";
    this.s11 = "áÁéÉíÍóÓúÚýÝćĆĺĹńŃŕŔśŚźŹ";
    this.s12 = "aAeEiIoOuUyY";
    this.s13 = "äÄëËïÏöÖüÜÿŸ";
    this.s14 = "aAnNoO";
    this.s15 = "ãÃñÑõÕ";
