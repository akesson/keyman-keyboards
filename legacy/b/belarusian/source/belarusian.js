KeymanWeb.KR(new Keyboard_belarusian());

function Keyboard_belarusian() {
    this.KI = "Keyboard_belarusian";
    this.KN = "Belarusian";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("ё", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "й", "ц", "у", "к", "е", "н", "г", "ш", "ў", "з", "х", "'", "\\", "", "", "", "ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "", "", "", "", "", "\\", "я", "ч", "с", "м", "і", "т", "ь", "б", "ю", ".", "", "", "", "", "", " ", "Ё", "!", "\"", "№", ";", "%", ":", "?", "*", "(", ")", "_", "+", "", "", "", "Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Ў", "З", "Х", "'", "/", "", "", "", "Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Э", "", "", "", "", "", "/", "Я", "Ч", "С", "М", "І", "Т", "Ь", "Б", "Ю", ",", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
