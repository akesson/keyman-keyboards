KeymanWeb.KR(new Keyboard_czech());

function Keyboard_czech() {
    this.KI = "Keyboard_czech";
    this.KN = "Czech";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 1,
        BK: new Array(";", "+", "ě", "š", "č", "ř", "ž", "ý", "á", "í", "é", "=", "´", "", "", "", "q", "w", "e", "r", "t", "z", "u", "i", "o", "p", "ú", ")", "¨", "", "", "", "a", "s", "d", "f", "g", "h", "j", "k", "l", "ů", "§", "", "", "", "", "", "\\", "y", "x", "c", "v", "b", "n", "m", ",", ".", "-", "", "", "", "", "", " ", "˚", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "%", "ˇ", "", "", "", "Q", "W", "E", "R", "T", "Z", "U", "I", "O", "P", "/", "(", "'", "", "", "", "A", "S", "D", "F", "G", "H", "J", "K", "L", "\"", "!", "", "", "", "", "", "|", "Y", "X", "C", "V", "B", "N", "M", "?", ":", "_", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "~", "ˇ", "^", "˘", "˚", "˛", "`", "˙", "´", "˝", "¨", "¸", "", "", "", "\\", "|", "€", "", "", "", "", "", "", "", "÷", "×", "¤", "", "", "", "", "đ", "Đ", "[", "]", "", "", "ł", "Ł", "$", "ß", "", "", "", "", "", "", "", "#", "&", "@", "{", "}", "", "<", ">", "*", "", "", "", "", "", "")
    };
    this.KH = '';
    this.KM = 0;
    this.s7 = " oOuU";
    this.s8 = "˝őŐűŰ";
    this.s9 = " cCdDeElLnNrRsStTzZ";
    this.s10 = "ˇčČďĎěĚľĽňŇřŘšŠťŤžŽ";
    this.s11 = " aAeEiIoOuU";
    this.s12 = "^âÂêÊîÎôÔûÛ";
    this.s13 = " aAgG";
    this.s14 = "˘ăĂğĞ";
    ...
    this.s21 = " eEiIzZ";
    this.s22 = "·ėĖıİżŻ";
    this.s23 = " aAcCeEiIlLnNoOrRsSuUyYzZ";
    this.s24 = "´áÁćĆéÉíÍĺĹńŃóÓŕŔśŚúÚýÝźŹ";
    this.s25 = " aAeEiIoOuUyY";
    this.s26 = "¨äÄëËïÏöÖüÜÿŸ";
    this.s27 = " cCgGkKlLnNrRsStT";
    this.s28 = "¸çÇģĢķĶļĻņŅŗŖşŞţŢ";
    ...
    this.g1 = function(t, e) {
        ...
        } else if (k.KDM(1, t, 6) && k.KA(0, k.KC(1, 1, t), this.s19)) {
            m = 1;
            k.KIO(1, this.s20, 1, t);
        } else if (k.KDM(1, t, 7) && k.KA(0, k.KC(1, 1, t), this.s21)) {
            m = 1;
            k.KIO(1, this.s22, 1, t);
        } else if (k.KDM(1, t, 8) && k.KA(0, k.KC(1, 1, t), this.s23)) {
            m = 1;
            k.KIO(1, this.s24, 1, t);
        } else if (k.KDM(1, t, 9) && k.KA(0, k.KC(1, 1, t), this.s25)) {
            m = 1;
            k.KIO(1, this.s26, 1, t);
        } else if (k.KDM(1, t, 10) && k.KA(0, k.KC(1, 1, t), this.s27)) {
            m = 1;
