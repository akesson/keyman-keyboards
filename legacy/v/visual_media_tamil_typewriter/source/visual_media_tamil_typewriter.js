KeymanWeb.KR(new Keyboard_visual_media_tamil_typewriter());

function Keyboard_visual_media_tamil_typewriter() {
    this.KI = "Keyboard_visual_media_tamil_typewriter";
    this.KN = "Tamil Typewriter (Visual Media)";
    this.KV = {
        F: ' 1em "Latha"',
        K102: 0,
        BK: new Array("ஃ", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "/", "=", "", "", "", "ணு", "ற", "ந", "ச", "வ", "ல", "ர", "ை", "டி", "ி", "ு", "ஹ", "க்ஷ", "", "", "", "ய", "ள", "ன", "க", "ப", "ா", "த", "ம", "ட", "்", "ங", "", "", "", "", "", "", "ண", "ஒ", "உ", "எ", "ெ", "ே", "அ", "இ", ",", ".", "", "", "", "", "", "", "'", "ஸ", "\"", "%", "ஜ", "ஶ", "ஷ", "", "", "(", ")", "ஸ்ரீ", "+", "", "", "", "", "று", "நு", "சு", "கூ", "லு", "ரு", "ஐ", "டீ", "ீ", "ூ", "ௌ", "௸", "", "", "", "", "ளு", "னு", "கு", "ழு", "ழ", "து", "மு", "டு", "`", "ஞ", "", "", "", "", "", "", "ஷ", "ஓ", "ஊ", "ஏ", "க்ஷ", "சூ", "ஆ", "ஈ", "?", "-", "", "", "", "", "", "")
    };
    this.KH = "Visual Media Tamil Typewriter layout";
    this.KM = 0;
