KeymanWeb.KR(new Keyboard_visual_media_tamil_modular());

function Keyboard_visual_media_tamil_modular() {
    this.KI = "Keyboard_visual_media_tamil_modular";
    this.KN = "Tamil Modular (Visual Media)";
    this.KV = {
        F: ' 1em "Latha"',
        K102: 0,
        BK: new Array("ௗ", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "றா", "ள", "ம", "ச", "ா", "த", "ை", "ட", "வ", "ன", "ஜ", "ஃ", "க்ஷ", "", "", "", "ர", "ற", "ண", "்", "க", "ி", "ீ", "ப", "ந", ";", "ு", "", "", "", "", "", "", "ஒ", "ழ", "ய", "ெ", "ே", "ங", "ல", ",", ".", "/", "", "", "", "", "", "", "ஔ", "!", "~", "\"", "ஶ", "%", "ூ", "ோ", "ொ", "(", ")", "_", "+", "", "", "", "ஸ", "ளு", "மு", "சு", "ஆ", "து", "ஐ", "டு", "வு", "னு", "ஷ", "ஹ", "ஸ்ரீ", "", "", "", "ரு", "று", "ணு", "அ", "கு", "இ", "ஈ", "பு", "நு", ":", "ஊ", "", "", "", "", "", "", "ஓ", "ழு", "யு", "எ", "ஏ", "ஞ", "லு", "னா", "உ", "?", "", "", "", "", "", "")
    };
    this.KH = "Visual Media Tamil Modular layout";
    this.KM = 0;
