KeymanWeb.KR(new Keyboard_urdu_kab());

function Keyboard_urdu_kab() {
    this.KI = "Keyboard_urdu_kab";
    this.KN = "KAB-Urdu-Unicode-Inscript";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "ط", "ص", "ھ", "د", "ٹ", "پ", "ت", "ب", "ج", "ح", "]", "[", "\\", "", "", "", "م", "و", "ر", "ن", "ل", "ہ", "ا", "ک", "ی", "؛", "'", "", "", "", "", "", "\\", "ق", "ف", "ے", "س", "ش", "غ", "ع", "،", "۔", "/", "", "", "", "", "", " ", "~", "!", "@", "#", "$", "٪", "^", "ۖ", "٭", ")", "(", "_", "+", "", "", "", "ظ", "ض", "ذ", "ڈ", "ث", "ّ", "ۃ", "ـ", "چ", "خ", "}", "{", "|", "", "", "", "ژ", "ز", "ڑ", "ں", "ۂ", "ء", "آ", "گ", "ي", ":", "\"", "", "", "", "", "", "|", "‍", "‌", "ۓ", "‎", "ؤ", "ئ", "‏", ">", "<", "؟", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ", "ﻲ", "", "", "", "", "", "", "", "ۙ", "", "", "", "", "", "", "", "", "ً", "ٍ", "ٌ", "", "", "", "", "ُ", "ِ", "َ", "ْ", "", "", "", "", "ۢ", "", "", "", "", "أ", "إ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "")
    };
    this.KH = '';
    this.KM = 0;
    this.KRTL = 1;
