KeymanWeb.KR(new Keyboard_us_dvorak_rh());

function Keyboard_us_dvorak_rh() {
    this.KI = "Keyboard_us_dvorak_rh";
    this.KN = "United States-Dvorak for right hand";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("`", "1", "2", "3", "4", "j", "l", "m", "f", "p", "/", "[", "]", "", "", "", "5", "6", "q", ".", "o", "r", "s", "u", "y", "b", ";", "=", "\\", "", "", "", "7", "8", "z", "a", "e", "h", "t", "d", "c", "k", "-", "", "", "", "", "", "\\", "9", "0", "x", ",", "i", "n", "w", "v", "g", "'", "", "", "", "", "", " ", "~", "!", "@", "#", "$", "J", "L", "M", "F", "P", "?", "{", "}", "", "", "", "%", "^", "Q", ">", "O", "R", "S", "U", "Y", "B", ":", "+", "|", "", "", "", "&", "*", "Z", "A", "E", "H", "T", "D", "C", "K", "_", "", "", "", "", "", "|", "(", ")", "X", "<", "I", "N", "W", "V", "G", "\"", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
