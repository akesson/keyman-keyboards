KeymanWeb.KR(new Keyboard_uzbek());

function Keyboard_uzbek() {
    this.KI = "Keyboard_uzbek";
    this.KN = "uzbek";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("ё", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "ғ", "ҳ", "", "", "", "й", "ц", "у", "к", "е", "н", "г", "ш", "ў", "з", "х", "ъ", "\\", "", "", "", "ф", "қ", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "", "", "", "", "", "\\", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", ".", "", "", "", "", "", " ", "Ё", "!", "\"", "№", ";", "%", ":", "?", "*", "(", ")", "Ғ", "Ҳ", "", "", "", "Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Ў", "З", "Х", "Ъ", "/", "", "", "", "Ф", "Қ", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Э", "", "", "", "", "", "/", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", ",", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = "<a href='http://help.keymanweb.com/go?Keyboard=uzbek'>Help for this keyboard</a>";
    this.s4 = "uzbek.kvk";
