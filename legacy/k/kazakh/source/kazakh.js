KeymanWeb.KR(new Keyboard_kazakh());

function Keyboard_kazakh() {
    this.KI = "Keyboard_kazakh";
    this.KN = "Kazakh";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 1,
        BK: new Array("(", "\"", "ә", "і", "ң", "ғ", ",", ".", "ү", "ұ", "қ", "ө", "һ", "", "", "", "й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ", "\\", "", "", "", "ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "", "", "", "", "", "\\", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "№", "", "", "", "", "", " ", ")", "!", "Ә", "І", "Ң", "Ғ", ";", ":", "Ү", "Ұ", "Қ", "Ө", "Һ", "", "", "", "Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ", "/", "", "", "", "Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Э", "", "", "", "", "", "|", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "?", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
