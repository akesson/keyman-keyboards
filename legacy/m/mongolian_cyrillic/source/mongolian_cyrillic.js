KeymanWeb.KR(new Keyboard_mongolian_cyrillic());

function Keyboard_mongolian_cyrillic() {
    this.KI = "Keyboard_mongolian_cyrillic";
    this.KN = "Mongolian Cyrillic";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("=", "№", "-", "\"", "₮", ":", ".", "_", ",", "%", "?", "е", "щ", "", "", "", "ф", "ц", "у", "ж", "э", "н", "г", "ш", "ү", "з", "к", "ъ", "\\", "", "", "", "й", "ы", "б", "ө", "а", "х", "р", "о", "л", "д", "п", "", "", "", "", "", "\\", "я", "ч", "ё", "с", "м", "и", "т", "ь", "в", "ю", "", "", "", "", "", " ", "+", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "Е", "Щ", "", "", "", "Ф", "Ц", "У", "Ж", "Э", "Н", "Г", "Ш", "Ү", "З", "К", "Ъ", "|", "", "", "", "Й", "Ы", "Б", "Ө", "А", "Х", "Р", "О", "Л", "Д", "П", "", "", "", "", "", "|", "Я", "Ч", "Ё", "С", "М", "И", "Т", "Ь", "В", "Ю", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
