KeymanWeb.KR(new Keyboard_arabic_101());

function Keyboard_arabic_101() {
    this.KI = "Keyboard_arabic_101";
    this.KN = "Arabic (101)";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("ذ", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "ض", "ص", "ث", "ق", "ف", "غ", "ع", "ه", "خ", "ح", "ج", "د", "\\", "", "", "", "ش", "س", "ي", "ب", "ل", "ا", "ت", "ن", "م", "ك", "ط", "", "", "", "", "", "\\", "ئ", "ء", "ؤ", "ر", "لا", "ى", "ة", "و", "ز", "ظ", "", "", "", "", "", " ", "ّ", "!", "@", "#", "$", "%", "^", "&", "*", ")", "(", "_", "+", "", "", "", "َ", "ً", "ُ", "ٌ", "لإ", "إ", "‘", "÷", "×", "؛", "<", ">", "|", "", "", "", "ِ", "ٍ", "]", "[", "لأ", "أ", "ـ", "،", "/", ":", "\"", "", "", "", "", "", "|", "~", "ْ", "}", "{", "لآ", "آ", "’", ",", ".", "؟", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ", "", "‍", "‌", "‎", "‏", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "")
    };
    this.KH = '';
    this.KM = 0;
    this.KRTL = 1;
