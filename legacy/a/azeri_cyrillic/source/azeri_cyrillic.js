KeymanWeb.KR(new Keyboard_azeri_cyrillic());

function Keyboard_azeri_cyrillic() {
    this.KI = "Keyboard_azeri_cyrillic";
    this.KN = "Azeri Cyrillic";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 1,
        BK: new Array("`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "ј", "ү", "у", "к", "е", "н", "г", "ш", "һ", "з", "х", "ҹ", "\\", "", "", "", "ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "ҝ", "", "", "", "", "", "\\", "ә", "ч", "с", "м", "и", "т", "ғ", "б", "ө", ".", "", "", "", "", "", " ", "~", "!", "\"", "№", ";", "%", ":", "?", "*", "(", ")", "_", "+", "", "", "", "Ј", "Ү", "У", "К", "Е", "Н", "Г", "Ш", "Һ", "З", "Х", "Ҹ", "/", "", "", "", "Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Ҝ", "", "", "", "", "", "|", "Ә", "Ч", "С", "М", "И", "Т", "Ғ", "Б", "Ө", ",", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
