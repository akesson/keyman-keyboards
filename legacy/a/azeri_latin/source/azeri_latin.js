KeymanWeb.KR(new Keyboard_azeri_latin());

function Keyboard_azeri_latin() {
    this.KI = "Keyboard_azeri_latin";
    this.KN = "Azeri Latin";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("`", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "-", "=", "", "", "", "q", "ü", "e", "r", "t", "y", "u", "i", "o", "p", "ö", "ğ", "\\", "", "", "", "a", "s", "d", "f", "g", "h", "j", "k", "l", "ı", "ə", "", "", "", "", "", "\\", "z", "x", "c", "v", "b", "n", "m", "ç", "ş", ".", "", "", "", "", "", " ", "~", "!", "\"", "Ⅶ", ";", "%", ":", "?", "*", "(", ")", "_", "+", "", "", "", "Q", "Ü", "E", "R", "T", "Y", "U", "İ", "O", "P", "Ö", "Ğ", "/", "", "", "", "A", "S", "D", "F", "G", "H", "J", "K", "L", "I", "Ə", "", "", "", "", "", "/", "Z", "X", "C", "V", "B", "N", "M", "Ç", "Ş", ",", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
