KeymanWeb.KR(new Keyboard_armenian_east());

function Keyboard_armenian_east() {
    this.KI = "Keyboard_armenian_east";
    this.KN = "Armenian Eastern";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("՝", ":", "ձ", "յ", "՛", ",", "-", ".", "«", "»", "օ", "ռ", "ժ", "", "", "", "խ", "ւ", "է", "ր", "տ", "ե", "ը", "ի", "ո", "պ", "չ", "ջ", "'", "", "", "", "ա", "ս", "դ", "ֆ", "ք", "հ", "ճ", "կ", "լ", "թ", "փ", "", "", "", "", "", "'", "զ", "ց", "գ", "վ", "բ", "ն", "մ", "շ", "ղ", "ծ", "", "", "", "", "", " ", "՜", "1", "Ձ", "Յ", "3", "4", "9", "և", "(", ")", "Օ", "Ռ", "Ժ", "", "", "", "Խ", "Ւ", "Է", "Ր", "Տ", "Ե", "Ը", "Ի", "Ո", "Պ", "Չ", "Ջ", "՞", "", "", "", "Ա", "Ս", "Դ", "Ֆ", "Ք", "Հ", "Ճ", "Կ", "Լ", "Թ", "Փ", "", "", "", "", "", "՞", "Զ", "Ց", "Գ", "Վ", "Բ", "Ն", "Մ", "Շ", "Ղ", "Ծ", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
