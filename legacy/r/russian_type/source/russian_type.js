KeymanWeb.KR(new Keyboard_russian_type());

function Keyboard_russian_type() {
    this.KI = "Keyboard_russian_type";
    this.KN = "Russian (Typewriter)";
    this.KV = {
        F: ' 1em "Arial"',
        K102: 0,
        BK: new Array("|", "№", "-", "/", "\"", ":", ",", ".", "_", "?", "%", "!", ";", "", "", "", "й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ", ")", "", "", "", "ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э", "", "", "", "", "", ")", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "ё", "", "", "", "", "", " ", "+", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", "=", "\\", "", "", "", "Й", "Ц", "У", "К", "Е", "Н", "Г", "Ш", "Щ", "З", "Х", "Ъ", "(", "", "", "", "Ф", "Ы", "В", "А", "П", "Р", "О", "Л", "Д", "Ж", "Э", "", "", "", "", "", "(", "Я", "Ч", "С", "М", "И", "Т", "Ь", "Б", "Ю", "Ё", "", "", "", "", "", " ", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", " ")
    };
    this.KH = '';
    this.KM = 0;
